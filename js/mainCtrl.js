angular.module('chatroom').controller('mainCtrl', function($scope, messageService){
  ...
  $scope.getMessages = function() {
    messageService.getData()
      .then(function(response) {

        $scope.messages = response.data.chats.reverse();
  ...
  $scope.postMessage = function(message) {
    messageSerbice.postMessage(message).then(function(response) {});
    $scope.message = '';
  };

  // $scope.getCookie = function(){
  //    messageService.getCookie()
  //    .then(function(response) {
  ...
  // $scope.getCookie();
  // $scope.postCookie = function(cookieName) {
  //  console.log(cookieName);
  //  messageService.postCookie(cookieName).then(function(response){});
  // };
